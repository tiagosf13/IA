...
def compare_decl_lists(l1,l2):
    ...
    print("L1:", set(l1_tuples), "len:", len(l1_tuples))
    print("L2:", set(l2_tuples), "len:", len(l2_tuples))
    print("L1==L2", set(l1_tuples)==set(l2_tuples))
    print("len_l1 ==len_l2", len(l1_tuples)==len(l2_tuples))
